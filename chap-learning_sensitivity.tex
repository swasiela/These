...
Moreover, the control input values $\u$ are required for the motion planning algorithm to perform robust feasibility checks, and their computation depends on \myglsentry{odes} forward integration (as shown in (Equation~\ref{eq:dyna_ctrl})). 
...
\subsubsection{Differential drive robot application}
