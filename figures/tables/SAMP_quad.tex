\begin{table*}[b!]
    ...
    \caption{
    \label{tab:samp_quad}
    Quadrotor application: Average planning time and success rate (no crash) of the simulated motions planned over 10 plans for the \myglsentry{rrtstar} and \myglsentry{sst*}, and 3 trajectories only for the \myglsentry{sarrt*} and \myglsentry{sasst*} due to very high planning time.
