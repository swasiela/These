\begin{table*}[t!]
    ...
    Quadrotor application: Average planning time and robust feasibility success rates of the simulated motions planned using standard non-robust RRT*, \myglsentry{sarrt*} (see Chapter~\ref{chap:samp}), \myglsentry{lazysarrt*} (see Chapter~\ref{chap:samp}) and the DeepSARRT* variant, all of them optimizing trajectory length.
