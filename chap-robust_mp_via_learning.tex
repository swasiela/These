...
\subsection{Global robust motion planning via learned sensitivity metrics}\label{sec:RSAMP}
...
This subsection presents comparison between the \myglsentry{deepsamp} variants, that leverage the GRU-based neural network, and the \myglsentry{samp} variants that solve the set of \myglsentry{odes}.
