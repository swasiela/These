...
\begin{itemize}
    ...
    Note that all nodes must be evaluated for optimal reconnection, as the sensitivity cost depends on the trajectory that has been taken to reach each node.
