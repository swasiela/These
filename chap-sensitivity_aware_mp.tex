...
\begin{figure} [htp]
    ...
    \subfloat[\centering Fixed \myglsentry{rrtstar}]{{\includegraphics[width=0.4\linewidth]{figures/samp/rrtstar_bounded.png} }}%
    \\
    \subfloat[\centering Fraction of the maximum space extent \myglsentry{sarrt*}]{{\includegraphics[width=0.4\linewidth]{figures/samp/sarrtstar_unbounded.png} }}%
    \subfloat[\centering Fixed \myglsentry{sarrt*}]{{\includegraphics[width=0.4\linewidth]{figures/samp/sarrtstar_bounded.png} }}%
