...
\begin{figure} [h]
    ...
    \subfloat[\centering Bounded local trajectory length]{{\includegraphics[width=0.4\linewidth]{figures/samp/rrtstar_bounded.png} }}%
...
Even if this leads to amainable computation time for simple systems such as the differential drive robots, the gap induced by solving the \myglsentry{odes} grows consequently when applied to more complex systems such as the quadrotor which involves a hundred of \myglsentry{odes}. 
