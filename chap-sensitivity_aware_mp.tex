...
Algorithm~\ref{alg:LazySARRT*} provides the pseudo-code of the \myglsentry{lazysarrt*} planner.  
...
The reason for this variant, as already mentioned in Section~\ref{sec:samp}, is that the sensitivity of a trajectory portion is not invariant but instead depends on the previous portions since the start of the motion.
