...
It is important to note that, in this thesis, the system state $\q$ is assumed to be perfectly known, as no sensor models are considered.
Consequently, the simulations and subsequent sensitivity computations are performed using the true system state $\q$, than the usual estimation of this state $\hat{\q}$.
