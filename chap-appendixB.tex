...
\begin{figure} [h]
    \centering
    \vspace{-0.2cm}
    \includegraphics[width=0.9\linewidth]{figures/learning_unic/learning_curves.png}
...
\begin{figure} [h]
    \centering
    \vspace{-1cm}
    \includegraphics[width=0.9\linewidth]{figures/learning_quadrotor/learning_curves.png}
